...
exports.coreDefinitions = {
    ...
    enableProgressBars: {
        ...
        type: SettingsType.BOOLEAN,
        default: !is_ci_1.default && process.stdout.isTTY && process.stdout.columns > 22,
        defaultText: `<dynamic>`,
    },
    enableTimers: {
...
function hideSecrets(rawValue, definition) {
...
class Configuration {
    ...
    getRedacted(key) {
        ...
        return hideSecrets(rawValue, definition);
    }
    ...
    format(text, colorRequest) {
        if (colorRequest === FormatType.PATH)
            text = fslib_1.npath.fromPortablePath(text);
