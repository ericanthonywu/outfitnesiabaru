...
const {filterProduk, searchProduk, listFilterProduk, filterProdukMaxharga} = require("../controlller/user/produkController");
const {
    carrouselAdmin,
    toggleFollow,
...
router.post('/filterProdukMaxharga', filterProdukMaxharga)
