...
const {addProduk, showProduk, showAllTokoProduk, deleteProduk, saveDisplayToko, showDisplayToko, editProduk, removeDisplayToko} = require("../controlller/toko/produkController");
...
router.post('/saveDisplayToko', authMiddleware, saveDisplayToko)
router.post('/removeDisplayToko', authMiddleware, removeDisplayToko)
router.get('/showDisplayToko', authMiddleware, showDisplayToko)
